...
* `travis-ci`: Linux and OSX based testing through [![Build Status](https://travis-ci.org/emleddin/sss_geometry_analysis.svg?branch=master)](https://travis-ci.org/emleddin/sss_geometry_analysis)
...
e.g. `geometry_analysis-0.1.2`, otherwise it will be appended with `+X` where `X` is the number of commits
